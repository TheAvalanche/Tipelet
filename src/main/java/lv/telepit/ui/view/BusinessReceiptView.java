...
public class BusinessReceiptView extends AbstractView {
    ...
    public void buildContent() {
        ...
        final HorizontalLayout searchLayout1 = new HorizontalLayout(idField, userField, storeField);
        searchLayout1.setSpacing(true);
        final HorizontalLayout searchLayout2 = new HorizontalLayout(receiverNameField, fromDateField, toDateField);
        ...
        final HorizontalLayout buttonLayout = new HorizontalLayout(addBusinessReceipt, updateBusinessReceipt, refreshButton);
