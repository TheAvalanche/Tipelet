...
public class ServiceStatusReturnedWithBillAction extends AbstractAction<ServiceView> {

    private final ServiceGood good;

    public ServiceStatusReturnedWithBillAction(ServiceGood good, ServiceView view) {
        super(view);
